...
void test_insertion_sort() { test_sort_algorithm(upo_insertion_sort); }

void test_merge_sort() { test_sort_algorithm(upo_merge_sort); }

void test_quick_sort() { test_sort_algorithm(upo_quick_sort); }

void test_bubble_sort() { test_sort_algorithm(upo_bubble_sort); }
